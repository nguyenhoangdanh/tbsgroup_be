...
export const ErrGroupHasUsers = new Error(
  'Nhóm đang có thành viên, không thể xóa',
);
export const ErrGroupHasProductionData = new Error(
  'Nhóm đang có dữ liệu sản xuất, không thể xóa',
);
...
export const groupSchema = z.object({
  ...
  code: z
    .string()
    .min(2, 'Mã nhóm phải có ít nhất 2 ký tự')
    .max(50, 'Mã nhóm không được quá 50 ký tự'),
  name: z
    .string()
