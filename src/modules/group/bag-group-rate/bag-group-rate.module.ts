...
import { BagGroupRateHttpController, BagGroupRateRpcHttpController } from './bag-group-rate-http.controller';
import { BAG_GROUP_RATE_REPOSITORY, BAG_GROUP_RATE_SERVICE } from './bag-group-rate.di-token';
